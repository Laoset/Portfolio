  ...
  return (
    ...
    >
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        <div className="pb-8">
          <p className="font-oswald text-nuevoWhite text-4xl font-extrabold inline border-b-4 border-gray-500 dark:text-black">
            Contacto
          </p>
          <p className="text-lg font-fireCode py-6 text-nuevoWhite dark:text-black dark:font-semibold ">
            ...
            encontrarme en otras redes sociales, prueba con el desplegable de la
            izquierda.
          </p>
        </div>
