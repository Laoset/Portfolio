...
const Proyecto = () => {
  ...
  return (
    <div name='Proyects' className='h-screen w-full text-white md:h-screen bg-gradient-to-b from-black to-gray-900 dark:bg-light'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full'>
            <div className='pb-4'>
                ...
                <p className='font-cardo py-6 text-nuevoWhite mx-m-md dark:font-semibold dark:text-black'>Look my proyects, i await your feedback.</p>
            </div>
            ...
            portfolios.map(({id,src,title,href,code})=>(
               <div key={id} className='shadow-md shadow-gray-600 rounded-lg'>
                        ...
                        <h2 className='font-cardo font-semibold text-lg pt-2 text-center'>{title}</h2>
                    <div className='flex items-center justify-center dark:bg-slate-200'>
                        <a href={href} target='_blank' rel='noreferrer' className='font-cardo cursor-pointer font-semibold w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105 text-slate-50 dark:text-black'>Deploy</a>
