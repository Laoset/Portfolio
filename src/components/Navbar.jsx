...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center w-full h-20 text-white fixed bg-black px-4 dark:bg-light'>
        <div>
            <h1 className='hover:animate-pulse text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-rose-400 text-5xl font-marca hover:from-red-400 hover:to-red-600'>Kevin</h1>
        </div>
